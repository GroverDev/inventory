...
public interface IUsersApplication
{
    ...
    public Task<Response<List<UserBranchResponse>>> GetBranchesByUser(Guid uuid);
    public Task<Response<bool>> AssignBranchesToUser(Guid uuid, UserBranchesRequest request, int modifiedBy);
