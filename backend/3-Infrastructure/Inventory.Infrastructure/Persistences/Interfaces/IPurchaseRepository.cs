...
public interface IPurchaseRepository
{
    ...
    public Task<List<PurchaseProductResponse>> GetPurchases(DateOnly purchaseDateInitial, DateOnly purchaseDateEnd, Domain.Enums.PurchaseStatusEnum purchaseStatus, Guid[]? branches = null);
