...
public interface ISalesRepository
{
    ...
    public Task<SalesPagedResponse> GetSales(DateTime saleDateInitial, DateTime saleDateEnd, int? userId = null, int page = 1, int pageSize = 50, string? sellerName = null, Guid[]? branches = null);
